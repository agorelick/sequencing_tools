...
## Summary:
## This script expects raw sequencing data with paired-end reads in the form of two FASTQs per sample, with filename format <PREFIX>_1.fq.gz, <PREFIX>_2.fq.gz.
